...
'use strict';
  ...
  (function () {
    ...
    var openPopupBigPicture = function () { // у меня в showBigPhoto
    ...
    var renderPicture = function (picture) { // у меня неполный renderPicture
    ...
    var clearPictures = function () { // у меня нет
    ...
    var drewPicture = function (objects) { // в модуле createPhotos
      clearPictures();
